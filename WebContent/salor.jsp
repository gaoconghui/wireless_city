...
.layout_all .wrapper_right .r_select .s_sort {
	margin-left: 20px;
}
...
.layout_all .wrapper_right .r_list .l_paging {
	height: 40px;
	margin: 0 auto;;
	margin-top: 10px;
	width: 210px;
...
.layout_all .wrapper_right .r_list .l_paging a {
	color: #0181ec;
	width: 20px;
	height: 20px;
	display: block;
...
.layout_all .wrapper_right .r_list .l_paging a.sel {
	border-color: #0181ec;
	background: #0181ec;
	color: #fff;
	font-weight: 700;
...
.layout_all .wrapper_right .r_list .l_paging .next {
	width: 60px;
}
		...
		<div class="wrapper_right">
			<div class="r_select">
				...
				<div class="s_attribute">
					<p>
						<span>属性1:</span> <span> <a href="javascript:void(0)">全部</a>
							<a href="javascript:void(0)">属性值1</a> <a
							href="javascript:void(0)">属性值2</a> <a href="javascript:void(0)">属性值3</a>
							<a href="javascript:void(0)">属性值4</a>
						</span>
					</p>
					<p>
						<span>属性2:</span> <span> <a href="javascript:void(0)">全部</a>
							<a href="javascript:void(0)">属性值1</a> <a
							href="javascript:void(0)">属性值2</a> <a href="javascript:void(0)">属性值3</a>
						</span>
					</p>
			...
			<div class="a_s_main">
				...
				<div class="a_s_attribute">
					...
					<div class="at_fill">
						...
						<div class="at_new" id="ut_new"></div>
					</div>
					<div class="clear"></div>
				</div>
				<div class="a_s_attibute"></div>
			...
			$("#submit")
					.on(
							...
							function() {
								...
								$("#l_content").find(".l_content:first")
										.slideDown("slow");
							});
			$("#new_attribute")
					.on(
