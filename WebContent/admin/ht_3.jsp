...
<html>
	<head>
		...
		/*start t_right*/
			...
			.tzht .t_right .r_table .r_label .l_tr:first-child{border:0;color:#fff;height:40px;line-height:40px;background:#1e90ff;font-size:14px;}
					...
					<div class="l_label">
						<div class="l_form" id="l_form">
							<div class="l_tr">
								...
								<span class="span">服务商</span>
								<span class="span">星级</span>
