...
<body>
		...
		<div class="t_left" id="t_left">
			...
			<div class="l_content">
				<ul id="choices">
					<li><a href="CatalogueAction_toCatalogueManagerPage"><i class="l_icon1"></i><span>服务类目管理</span><div class="clear"></div></a></li>
					<li><a href="TemplateAction_toTemplateManagerPage"><i class="l_icon2"></i><span>资源模板管理</span><div class="clear"></div></a></li>
					<li><a href="SearchProviderAction_getAllProviders"><i class="l_icon3"></i><span>服务商管理</span><div class="clear"></div></a></li>
