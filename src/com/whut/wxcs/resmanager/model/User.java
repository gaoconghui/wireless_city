 ...
 * 
 * @author apple
 *字段名	类型	长度	约束条件	允许空	注释
 *	id	bigint	32	主键	否	用户ID
 *	name	varchar	60		否	用户名
 *	LoginPwd	varchar	60		否	登录密码
 *	PayPwd	varchar	60		否	支付密码
 *	RealName	varchar	60		否	真实姓名
 *	PhoneNumber	varchar	60		否	手机号码
 *	Email	varchar	60		是	绑定邮箱
 *	LastLoginTime	datetime			否	登录时间
 *	LastLoginPlace	varchar	20		否	登录地点
 *	LoginTimes	int			否	登录次数
