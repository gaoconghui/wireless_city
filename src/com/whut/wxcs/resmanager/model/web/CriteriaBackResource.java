...
public class CriteriaBackResource {
	...
	public static Integer ORDER_BY_CATALOGUE = 3;
	public static Integer ORDER_BY_PROVIDER = 4;
	...
	static {
		...
		orderMap.put(ORDER_BY_REGISTER_TIME, "create_time");
		orderMap.put(ORDER_BY_NAME, "resource_name");
		orderMap.put(ORDER_BY_CATALOGUE, "catalogue");
		orderMap.put(ORDER_BY_PROVIDER, "provider");
	}
	...
	// 根据什么排序 0是按checkState 1是按时间 2是名字 3是类目 4是服务商...
	...
	public static void setOrderMap(Map<Integer, String> orderMap) {
		CriteriaBackResource.orderMap = orderMap;
	}

	@Override
	public String toString() {
		return "CriteriaBackResource [checkState=" + checkState + ", keyWord="
