...
//		templateDao.updateEntity(template);
	...
	public void testGetCatalogue(){
		Catalogue catalogue = catalogueDao.getEntity(101);
		Map<String,String> map = new HashMap<String, String>();
		map.put("id", catalogue.getId()+"");
		map.put("description", catalogue.getDescription());
		map.put("name", catalogue.getName());
		Gson gson = new Gson();
	...
	public void testGetAttributes(){
		...
		try {
			attributes = catalogueService.getAttributesByTid(1);
